        ...
        <div className="pt-32 pb-24 flex items-center justify-center px-4">
            <div className="max-w-md w-full space-y-8 bg-white p-10 border border-beige-200">
                <div className="text-center">
                    <h2 className="text-3xl font-normal text-darkgray-900 tracking-tight uppercase">Join MINIMA</h2>
                    <p className="mt-2 text-sm text-darkgray-800 uppercase tracking-widest">Create your studio account</p>
                </div>

                {success ? (
                    <div className="text-center py-8">
                        <div className="text-green-600 text-sm uppercase tracking-widest mb-4">Registration Successful!</div>
                        <p className="text-xs text-darkgray-800">Check your email for confirmation. Redirecting to login...</p>
                    </div>
                ) : (
                ...
                {!success && (
                    <div className="text-center pt-4 border-t border-beige-200">
                        <p className="text-xs text-darkgray-800 uppercase tracking-widest">
                            ...
                            <Link to="/login" className="text-darkgray-900 hover:underline underline-offset-4 font-normal">
                                Sign In
                            </Link>
                        </p>
                    </div>
